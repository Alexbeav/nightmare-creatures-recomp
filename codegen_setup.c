...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Nightmare Creatures",
    .project_root_env = "NIGHTMARE_CREATURES_RECOMP_PROJECT_ROOT",
    .build_dir_env = "NIGHTMARE_CREATURES_RECOMP_BUILD_DIR",
    .force_setup_env = "NIGHTMARE_CREATURES_RECOMP_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_005.82_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Nightmare_Creatures__Recompiled",
    .prepare_note =
